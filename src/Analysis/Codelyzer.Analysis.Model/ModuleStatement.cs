...
{
    public class ModuleStatement : UstNode
    {
        ...
        public ModuleStatement()
            : base(IdConstants.ModuleStatementName)
        {
        ...
        {
            if (obj is ModuleStatement)
            {
                return Equals(obj as ModuleStatement);
            }
            return false;
        }

        public bool Equals(ModuleStatement compareNode)
        {
            return
                compareNode != null &&
