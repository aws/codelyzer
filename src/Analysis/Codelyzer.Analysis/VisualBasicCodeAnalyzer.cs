...
{
    /// <summary>
    /// Code analyzer for VisualBasic
    /// </summary>
    public class VisualBasicCodeAnalyzer : CodeAnalyzer
    {
        public VisualBasicCodeAnalyzer(AnalyzerConfiguration configuration, ILogger logger)
